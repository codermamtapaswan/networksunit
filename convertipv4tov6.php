...
if (isset($_POST['convert_IP'])) {
    $ipv4_address = $_POST['IPv4_Address'];    
if (filter_var($ipv4_address, FILTER_VALIDATE_IP)) {
        if($ipv4_address){
            $ipv6_address = ipv4to6($ipv4_address);         
        }
        else{
        ...
        $message = '<span class="ip-address h2">' . $ipv4_address . '</span>is Not a valid IP address';
...
<head>
    ...
    <title>Convert IPv4 to IPv6</title>
                        ...
                        <button type="submit" class="search-btn trip-btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                ...
                                <path
                                    ...
                                    stroke="#3D564A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                </path>
                            </svg>
                        </button>
                    </form>
                ...
                <nav>
                    <ul>
                        ...
                        <div class="cancel-btn" onclick="toggleButtons()">
                            <svg fill="#000" xmlns="http://www.w3.org/2000/svg" height="18" width="18"
                                viewBox="0 0 384 512">
                                <path
    ...
    <main>
        ...
        <div class="bg-img tools-page-bg">
            <div class="container">
                <div class="row">
                    <p id="breadcrumbs">
                        <span><span><a href="#">Social Media</a></span> &gt;
                         <span><a href="#">Facebook</a></span> &gt; 
                         <span><a href="#">Facebook</a></span></span>
                    </p>
                    ...
                    <div class="col-lg-12">
                        <div class="tools-page-box-flex">
                            <div class="h4 mb-mob-0">Convert IPv4 to IPv6.</div>

                            <form method="post">
                                <input type="text"  name="IPv4_Address" placeholder="Enter IPv4 Address Here" required>
                                <div class="btn-container-flex">
                                    <button class="secondry-btn btn-flex" name="convert_IP"> Convert </button>
                                </div>
                            </form>                         
        ...
        <div class="container mb-4">
            <?php
                if (isset($ipv6_address)): 
                    // $ipv6_address = ipv4to6($ipv4_address); 
                        $ipv6_compressed = '::ffff:' .  $ipv6_address;
                        $ipv6_shortened = '0:0:0:0:0:fff:' .  $ipv6_address;
                        $ipv6_expanded = '0000:0000:0000:0000:0000:ffff:' .  $ipv6_address;
            ?>
                    ...
                    <div class="col-lg-12">
                        <figure class="wp-block-table is-style-stripes">
                            <table>
                                <tbody>
                                    <tr>
                                        <th>IPV6 Compressed:</th>
                                        <td class="copy-text"><?php  echo $ipv6_compressed;?></td>
                                        <td class="copyboard">
                                    ...
                                    <tr>
                                        <th>IPV6 Expanded (Shortened):</th>
                                        <td class="copy-text"><?php echo $ipv6_shortened;?> </td>
                                        <td class="copyboard"><svg width="16" height="16"
                                                xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <tr>
                                        <th>IPV6 Expanded:</th>
                                        <td class="copy-text"><?php  echo $ipv6_expanded;?></td>
                                        <td class="copyboard"><svg width="16" height="16"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                <path
        ...
        <div class="container">
            <div class="row mb-4">
                ...
                <div class="col-lg-4 mb-3">
                    <span>
                        <img src="https://plus.unsplash.com/premium_photo-1677564923729-5eeacd594495?q=80&w=1548&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                            alt="" class="img-fluid">
                    </span>
                </div>
                <div class="col-lg-12">
        ...
        <div class="tools-bg-flex mb-5">
            <div class="container">
                <div class="row">
                    ...
                    <p>Check blacklists for your IP address by entering the address into the tool above. If you don't
                        know your IP
                        address, the What's My IP address homepage shows you your IP address and its details. It also
                        lets you
                        conveniently copy and paste your IP into this tool to run a scan.
                    </p>
                    <p>The IP blacklist checker tool will search IP blacklist sites and report a table of various
                        blacklists. It
                        lists the block status of each of your server IP addresses.
                    </p>
                    <p>Domain name blacklists don’t notify users when their IP address goes on a blocklist. Users need
                        to check name
                        blacklists to find their status.
                    </p>
                    <p class="mb-0">Therefore, blacklist checks are essential for users, mail servers, or businesses who
                        believe that they have a
                        blacklisted IP address. If your IP is blocked, you'll show up on the list. Using the tool above
                        is the easiest
        ...
        <div class="container mb-4">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>Blocklists add IP addresses for many reasons. The intention is to protect other websites and
                        users from
                        dangerous IP addresses. However, sometimes blocklists wrongfully list other IPs on the list.
                        Therefore, a
                        normal, safe IP is blocked. Then, a user who hasn't done anything wrong will see their address
                        in an IP block
                        lookup.</p>
                    <p>You may do a blacklist check online and find your own IP on a blacklist. A blacklist typically
                        adds an IP for
                ...
                <div class="col-lg-8 all-page">
                    <ul class="mb-0">
                        ...
                        <li>Your device has a malware infection, which then could spread to other devices on the network
                        </li>
        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <p>As mentioned above, domain name server blocklists are the primary defense against spam as they block
                    IP
                    addresses believed to be spam accounts. However, there are also spam uniform resource identifier
                    blocklists
                    (SURBLs) that serve as backup defenses. These blacklists note websites that appear in unsolicited
                    emails.
                    However, not all email spam filters have the capacity to use them.</p>
                <p>Spam filters that can utilize the SURBLs scan the body text of emails, extract any website addresses
                    present,
                    and check them against blacklists. If the server finds an address, it flags the message as spam and
                    handles it
                    accordingly.</p>
                <p class="mb-0">Since both methods filter spam differently, they are most effective when combined.
                    Unfortunately, as spammers
                    become more clever, there is no method capable of catching every spam message. Users must be
                    vigilant in
            ...
            <div class="row mb-4">
                <div class="col-lg-3 mb-3 col-md-6">
                    <div class="tools-box-flex">
                        ...
                        <p class="truncate">It is a long established fact that a reader will be distracted by the rea
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 mb-3 col-md-6">
