...
if (isset($_POST['convert_IP'])) {
    ...
    if (filter_var($ipv4_address, FILTER_VALIDATE_IP)) {
        ...
        $message = '<span class="ip-address h2">' . htmlspecialchars($ipv4_address) . '</span> is Not a valid IP address';
    }
}
                    ...
                    <form action="">
                        ...
                        <button type="submit" class="search-btn trip-btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M7.333 12.667A5.333 5.333 0 1 0 7.333 2a5.333 5.333 0 0 0 0 10.667ZM14 14l-2.9-2.9" stroke="#3D564A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                </path>
                            </svg>
                        </button>
                    </form>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="copy-text"><?php echo htmlspecialchars($ipv6_compressed); ?></td>
                                            <td class="copyboard">
                                        ...
                                        <tr>
                                            ...
                                            <td class="copy-text"><?php echo htmlspecialchars($ipv6_shortened); ?></td>
                                            <td class="copyboard">
                                                <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                                    <path d="M384 336H192c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16l140.1 0L400 115.9V320c0 8.8-7.2 16-16 16zM192 384H384c35.3 0 64-28.7 64-64V115.9c0-12.7-5.1-24.9-14.1-33.9L366.1 14.1c-9-9-21.2-14.1-33.9-14.1H192c-35.3 0-64 28.7-64 64V320c0 35.3 28.7 64 64 64zM64 128c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H256c35.3 0 64-28.7 64-64V416H272v32c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192c0-8.8 7.2-16 16-16H96V128H64z" />
                                                </svg>
                                        ...
                                        <tr>
                                            <th>IPV6 Expanded:</th>
                                            <td class="copy-text"><?php echo htmlspecialchars($ipv6_expanded); ?></td>
                                            <td class="copyboard">
                                                <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                                    <path d="M384 336H192c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16l140.1 0L400 115.9V320c0 8.8-7.2 16-16 16zM192 384H384c35.3 0 64-28.7 64-64V115.9c0-12.7-5.1-24.9-14.1-33.9L366.1 14.1c-9-9-21.2-14.1-33.9-14.1H192c-35.3 0-64 28.7-64 64V320c0 35.3 28.7 64 64 64zM64 128c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H256c35.3 0 64-28.7 64-64V416H272v32c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192c0-8.8 7.2-16 16-16H96V128H64z" />
                                                </svg>
