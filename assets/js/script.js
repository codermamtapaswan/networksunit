...
function toggleButtons() {
  ...
  if (toggleBtn && cancelBtn && headerUl) {
    ...
    cancelBtn.style.display =
      cancelBtn.style.display === "flex" ? "none" : "flex";
  }
}
  ...
  (entries) => {
    entries.forEach((entry) => {
      ...
      const link = document.querySelector(
        `.tableofcontent ul li a[href="#${targetId}"]`
      );
...
//   document.querySelectorAll(".copyboard").forEach((element) => {
//     element.addEventListener("click", function () {
//       const tr = this.closest("tr");
//       if (tr) {
//         copyRowContent(tr);
//         // Change the SVG content
//         const svgElement = tr.querySelector("td svg");
//         if (svgElement) {
//           // Change selection color directly
