...
$user_agent = $_SERVER['HTTP_USER_AGENT'];
    ...
    ***********************************/
    ...
    //             if (
    //             strpos($this->httpHeaders[$mobileHeader], $_match) !== false
    //             ) {
    //             return true;
    //             }
    //         }
    ...
    function what_is_my_ip_data() {
        ...
        if (!$client_browser) {
            $client_browser = "Browser is not Detected";
        }
        ...
        if ($clientIPs) {
            $ipv4 = implode(', ', $clientIPs['ipv4']) ?: "IPv4 is not Detected!";
            $ipv6 = implode(', ', $clientIPs['ipv6']) ?: "IPv6 is not Detected!";
        } else {
            $ipv4 = "IP is not Detected!";
            $ipv6 = "IP is not Detected!";
        }
